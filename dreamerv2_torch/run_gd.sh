...
#SBATCH --job-name GD1             # short: -J <job name>
...
python3 dreamerv2_torch/train.py --logdir logs/cartpole_gd/1 --configs dmc_vision --task dmc_cartpole_swingup --task_behavior grad --seed 1
